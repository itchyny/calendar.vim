...
" Author: itchyny
" License: MIT License
" Last Change: 2013/10/23 10:07:32.
" =============================================================================

let s:save_cpo = &cpo
set cpo&vim

function! calendar#constructor#year#new(day_constructor)
  return extend({ 'day_constructor': a:day_constructor, 'cache': {} }, s:constructor)
endfunction

let s:constructor = {}

function! s:constructor.new(y) dict
...
function! s:instance.new(y) dict
...
function! s:instance.sub(year) dict
  return self.get_y() - a:year.get_y()
endfunction

function! s:instance.eq(year) dict
  return self.get_y() == a:year.get_y()
endfunction
...
function! s:instance.get_y() dict
