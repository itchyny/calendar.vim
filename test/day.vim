...
function! s:suite.gregorian()
  ...
  for test in tests
    ...
    call s:assert.equals(day.mjd.mjd, mjd)
...
function! s:suite.add_sub()
  ...
  for test in tests
    ...
    call s:assert.equals(day.sub(calendar#day#default#new(new_ymd[0], new_ymd[1], new_ymd[2])), -diff)
    call s:assert.equals(calendar#day#default#new(new_ymd[0], new_ymd[1], new_ymd[2]).sub(day), diff)
  endfor
endfunction
